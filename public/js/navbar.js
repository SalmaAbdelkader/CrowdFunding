  ...
  return `
     <nav class="nav">
      ...
      <ul class="nav__list">
        ...
        <li><a href="public/pages/groupcampaign.html" class="nav-link">Campaigns</a></li>
      </ul>
      <div class="menu">
...
export let NavBar = () => {
  ...
  if (token) {
    ...
    navSign.innerHTML = ` 
      <a href="public/pages/regester.html"> <button class="log btn btn--full">Register</button></a>
      <a href="public/pages/login.html"> <button id="login" class="log btn btn--full">Login</button></a>
    `;
